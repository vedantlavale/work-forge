          ...
          <div className="relative pt-16 md:pt-24">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Transform your content strategy with our AI writing assistant.
                  Create blog posts, social media content, and marketing copy
                  10x faster with human-like quality.
                </TextEffect>
